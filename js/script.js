...
for (var i = 1; i <= 100; i++) {
    ...
    // 2. prendo il primo numero che è sia un multiplo di 3 che di 5, se ha resto = 0 stampo "FizzBuzz", in questo modo anche tutti i successivi multipli di entrambi i numeri avranno stampato "FizzBuzz"
    if (i % 15 == 0) {
